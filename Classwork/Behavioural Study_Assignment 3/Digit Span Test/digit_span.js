...
function three_digitsLoopBegin(three_digitsLoopScheduler) {
  ...
  for (const thisThree_digit of three_digits) {
...
function four_digitsLoopBegin(four_digitsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisFour_digit of four_digits) {
...
function five_digitsLoopBegin(five_digitsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisFive_digit of five_digits) {
...
function six_digitsLoopBegin(six_digitsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSix_digit of six_digits) {
...
function seven_digitsLoopBegin(seven_digitsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSeven_digit of seven_digits) {
...
function eight_digitsLoopBegin(eight_digitsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisEight_digit of eight_digits) {
...
function nine_digitsLoopBegin(nine_digitsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisNine_digit of nine_digits) {
...
function routine_3digitsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of routine_3digitsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function routine_4digitsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of routine_4digitsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function routine_5digitsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of routine_5digitsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function routine_6digitsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of routine_6digitsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function routine_7digitsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of routine_7digitsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function routine_8digitsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of routine_8digitsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function routine_9digitsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of routine_9digitsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
